...
This document lists more examples beyond those in the main [README](../README.md). To run all of them in one go, use [examples/examples.jsonl](../examples/examples.jsonl) with the `--jsonl_path` option (see the README section "Test Multiple Questions in a Single Run").
